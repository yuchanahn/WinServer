...
public struct fDamage : IFlatbufferObject
{
  ...
  public int Dcolor { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  public Vec3? Pos { get { int o = __p.__offset(10); return o != 0 ? (Vec3?)(new Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public bool BCri { get { int o = __p.__offset(12); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }

  public static void StartfDamage(FlatBufferBuilder builder) { builder.StartObject(5); }
  ...
  public static void AddDcolor(FlatBufferBuilder builder, int dcolor) { builder.AddInt(2, dcolor, 0); }
  public static void AddPos(FlatBufferBuilder builder, Offset<Vec3> PosOffset) { builder.AddStruct(3, PosOffset.Value, 0); }
  public static void AddBCri(FlatBufferBuilder builder, bool bCri) { builder.AddBool(4, bCri, false); }
